...
<div class="container">
    <div class="header">
            <!--Меню в шапке-->
            <a href="/robotica/main"><img class="logo floating_left_img" src="pictures/logo.png" alt="Robotica logo"></a>
            <ul class="menu">
    ...
    <div class="content">
        ...
        <a href="./pictures/mi_large.jpg" target="_blank">
            <img class="borderedimg floating_left_img catalog_img" src="./pictures/mi_small.jpg" alt="Xiaomi Mi">
        </a>
        <p>
            <form action="">
